...
$(document).ready(function()
{
  ...
  function show_overlay() { _launcher.aria('haspopup', true).aria('owns', 'speaker-overlay'); _content.html($(_launcher.attr('href').match(/#.+/)[0]).html()); _overlay.aria('hidden', false).focus(); }
  ...
  $('#sec-speakers').hide();
  $('#sec-program .speakers a').attr('role', 'button').click(function() { _launcher = $(this); show_overlay(); return false; });
